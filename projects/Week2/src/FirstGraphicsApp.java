...
public class FirstGraphicsApp {
    public static void main(String[] args) {
        GWindow w = new GWindow("First Graphics Window", 800, 600);
        Rectangle r = new Rectangle(300, 100, 180, 75, Color.BLUE, true);
        Rectangle r1 = new Rectangle(500, 300, 180, 75, Color.cyan, false);
        Rectangle bdg = new Rectangle(0, 0, 800, 600, Color.gray, true);
        // use the add method to place the rectangle in the window
        w.add(bdg); //depending on when you add the shapes, it'll overlay on top
        w.add(r);
        w.add(r1);
